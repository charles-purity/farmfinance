(function(){
    ...
    if(url_structure == 'none') {
        ...
        function load_tlib(){if(!window.gt_translate_script){window.gt_translate_script=document.createElement('script');gt_translate_script.src='../translate.google.com/translate_a/element7876.js';document.body.appendChild(gt_translate_script);}}
