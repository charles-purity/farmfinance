...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(in_array(config('basic.theme'),['lightpink','lightyellow'])): ?>

                            <div class="form-group col-md-3">
                                <label class="font-weight-bold"><?php echo app('translator')->get('Base Light Color'); ?></label>
                                <input type="color" name="base_light_color"
                                       value="<?php echo e(old('base_light_color') ?? $control->base_light_color ?? '#6777ef'); ?>"
                                       required="required" class="form-control ">
                                <?php $__errorArgs = ['base_light_color'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-3">
                                <label class="font-weight-bold"><?php echo app('translator')->get('Secondary Color'); ?></label>
                                <input type="color" name="secondary_color"
                                       value="<?php echo e(old('secondary_color') ?? $control->secondary_color ?? '#6777ef'); ?>"
                                       required="required" class="form-control ">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-3">
                                <label class="font-weight-bold"><?php echo app('translator')->get('Heading Color'); ?></label>
                                <input type="color" name="heading_color"
                                       value="<?php echo e(old('heading_color') ?? $control->heading_color ?? '#6777ef'); ?>"
                                       required="required" class="form-control ">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        ...
                        <input type="text" name="min_transfer"
                               value="<?php echo e(old('min_transfer') ?? $control->min_transfer ?? '1'); ?>"
                               required="required" class="form-control ">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        ...
                        <input type="text" name="max_transfer"
                               value="<?php echo e(old('max_transfer') ?? $control->max_transfer ?? '1000'); ?>"
                               required="required" class="form-control ">
                    ...
                    <div class="form-group col-sm-3 col-12">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="transfer_charge"
                                   value="<?php echo e(old('transfer_charge') ?? $control->transfer_charge ?? '1'); ?>"
                                   required="required" class="form-control ">
                    ...
                    <div class="form-group col-sm-3 col-12">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="bonus_amount"
                                   value="<?php echo e(old('bonus_amount') ?? $control->bonus_amount ?? '0'); ?>"
                                   required="required" class="form-control ">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u855564087/domains/priorityparcel.org/public_html/resources/views/admin/basic-controls.blade.php ENDPATH**/ ?>