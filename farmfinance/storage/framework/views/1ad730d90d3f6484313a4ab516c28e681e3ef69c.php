                ...
                <div class="row g-4 mb-4">
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box">
                            ...
                            <h3><small><sup><?php echo e(trans(config('basic.currency_symbol'))); ?></sup></small><?php echo e(getAmount($walletBalance, config('basic.fraction_number'))); ?></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-2">
                            ...
                            <h3><small><sup><?php echo e(trans(config('basic.currency_symbol'))); ?></sup></small><?php echo e(getAmount($interestBalance, config('basic.fraction_number'))); ?></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-3">
                            ...
                            <h3><small><sup><?php echo e(trans(config('basic.currency_symbol'))); ?></sup></small><?php echo e(getAmount($totalDeposit, config('basic.fraction_number'))); ?></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <h5><?php echo app('translator')->get('Total Earn'); ?></h5>
                            <h3><small><sup><?php echo e(trans(config('basic.currency_symbol'))); ?></sup></small><?php echo e(getAmount($totalInterestProfit, config('basic.fraction_number'))); ?></h3>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box">
                            ...
                            <h3><small><sup><?php echo e(trans(config('basic.currency_symbol'))); ?></sup></small><?php echo e(getAmount($roi['totalInvestAmount'])); ?></h3>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="dashboard-box box-2">
                            ...
                            <h3><small><sup><?php echo e(trans(config('basic.currency_symbol'))); ?></sup></small><?php echo e(getAmount($totalPayout)); ?></h3>
                    ...
                    <div class="<?php echo e(auth()->user()->rank ? 'col-xl-6':'col-xl-9'); ?>  col-md-12">
                        <div class="dashboard-box">
                            ...
                            <div class="input-group mb-3 cutom__referal_input__group">
                                <input type="text" class="form-control" value="<?php echo e(route('register.sponsor',[Auth::user()->username])); ?>" id="sponsorURL" readonly>
                                <button class="input-group-text btn-custom copy__referal_btn copytext" id="copyBoard" onclick="copyFunction()"><?php echo app('translator')->get('copy link'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u855564087/domains/priorityparcel.org/public_html/resources/views/themes/lightyellow/user/dashboard.blade.php ENDPATH**/ ?>