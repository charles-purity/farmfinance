...
<?php echo $__env->make('plugins', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        root.style.setProperty('--primary', '<?php echo e(config('basic.base_color')??'#f7931e'); ?>');
    </script>

</body>
</html>
<?php /**PATH /home/u855564087/domains/priorityparcel.org/public_html/resources/views/themes/lightyellow/layouts/user.blade.php ENDPATH**/ ?>